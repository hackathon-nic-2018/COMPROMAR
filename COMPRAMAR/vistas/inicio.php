...
<body>
      ...
      <div class="carousel-inner">
        <div class="item active" style="background-image: url(../img/pescado/pescado1.jpg)">
          <div class="caption">
            ...
            <p class="animated fadeInRightBig">Espacio habilitado para los emprendedores del sector pesquera para ofertar sus productos al mercado Local, Regional y Nacional. </p>
        ...
        <div class="item" style="background-image: url(../img/pescado/pescado3.jpg)">
          <div class="caption">
            ...
            <p class="animated fadeInRightBig">WAN UPLIKA DUKIARA DAUKAN HELP MUNAYA DUKIARA</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#features">Empecemos</a>
          </div>
        </div>
        <div class="item" style="background-image: url(../img/pescado/pescado4.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">WELCOME <span>TO COMPROMARC</span></h1>
            <p class="animated fadeInRightBig"> Space enabled for the entrepreneurs of the fishing sector to offer their products to the local, regional and natonal market</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#features">Empecemos</a>
          </div>
        </div>
      </div>
  ...
  <p><a><tr>Productos recientes</tr></a></p>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            <p class="pull-right">&copy;Copyright COMPROMARC 2018<a href="http/"></a></p>
